...
const FAQPage: React.FC<PageProps> = () => {
  ...
  return (
    <Layout>
      ...
      <Grid>
        <GridCell span={12}>
          <Typography use="headline3">Frequently Asked Questions</Typography>
          <br />
          <Typography use="body1" style={{ paddingLeft: "1rem" }}>
            If you're looking for a schedule of events, it can be found{" "}
            <Link to={"/schedule-of-events"}>here</Link>
          </Typography>
        </GridCell>
        <GridCell span={12}>
