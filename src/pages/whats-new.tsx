...
const WhatsNewPage: React.FC<PageProps> = () => {
  ...
  return (
    <Layout>
      ...
      <Grid>
        <GridCell span={12}>
          <Typography use="headline4">{pageData.metaData.pageTitle}</Typography>
          <br />
          <Typography use="body1">{pageData.metaData.pageContent}</Typography>
        </GridCell>
          ...
          <GridCell span={4} key={c.cardTitle}>
            <Card style={canvas}>
              ...
              <div style={{ padding: "1rem" }}>
                <Typography use="headline5">{c.cardTitle}</Typography>
